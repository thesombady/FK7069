...
Therefore, the indication of $Re$ eliminates the inertial term compared to the viscous term. When the Reynolds number is small, the fluid can withstand both tensil and tangential stresses.
...
there exist a flow between the two surfaces that allows 'slipping' and thus friction is reduced.
\end{document}
